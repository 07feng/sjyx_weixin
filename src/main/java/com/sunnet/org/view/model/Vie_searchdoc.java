...
@Entity
@Table(name = "vie_searchDoc")
public class Vie_searchdoc{
	...
	private String filetypename;// 文件类型（0图片，1视频）
	...
	private int ispublic; // 是否公开（0不公开，1公开）
	...
	public void getMap() {
		...
		ModelUtil.total.put("membername", "用户名称");
		/*ModelUtil.total.put("labelname", "标签名称");*/
		ModelUtil.total.put("type_name", "分类名称");
		ModelUtil.total.put("filetypename", "文件类型");
