...
public class vie_docpayUtil {
	 ...
	 * @return
	 */
	public static List getControllerList(List<vie_docpay> list) {
	 ...
	 * @return
	 */
	public static Map getControllerMap(vie_docpay obj) {
		Map<Object, Object> map = new HashMap<Object, Object>();
	 ...
	 * @return
	 */
	public static List getControllerListAll(List<vie_docpay> list) {
		List item = new ArrayList();
		for (vie_docpay obj : list) {
			Map<Object, Object> map = new HashMap<Object, Object>();
