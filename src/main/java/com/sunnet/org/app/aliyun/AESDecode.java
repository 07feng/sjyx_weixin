...
public class AESDecode {
    ...
    public static void main(String[] args) throws Exception {
        // 发送POST请求示例
        String ak_id1 = "LTAIY0Jv7xZqzXRb"; //用户ak
        String ak_secret1 = "3lbP3EXKJyA9QRtVH5irmSPwe6P7ft"; // 用户ak_secret
        String url = "https://dtplus-cn-shanghai.data.aliyuncs.com";
        //String body = "{\"param1\": \"123\", \"param2\":\"1234567\"}";
        String body = "{"+  
	    		   "\"type\":0 "+
	    		   "\"image_url\":\" http://sjyximage.oss-cn-shenzhen.aliyuncs.com/201708215/20170803055818922-2707370397.jpeg\" "+
	    "}";
