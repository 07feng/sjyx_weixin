...
public class DateUtil {
	...
	public static String getDatePoor(Date endDate, Date nowDate) {
		...
		if(day/365 > 0)
			return day/365 + "年前";	//+ min + "分钟"
		if(day/30 > 0)
			return day/30 + "个月前";	//+ min + "分钟"
		if(day >0)
			return day + "天前";	//+ min + "分钟"
		if(hour >0)
			return hour + "小时前";
		if(min >1)
			return min + "分钟前";
	...
	public static boolean areSameDay(Date dateA,Date dateB) {
		String time1 = new SimpleDateFormat("yyyy-MM-dd").format(dateA);
		String time2 = new SimpleDateFormat("yyyy-MM-dd").format(dateB);
	...
	public static void main(String[] args) throws ParseException {
		...
		// //生成唯一编号
		 System.out.println(getToYYMMDD(addDay(new Date(),-1)));
		// System.out.println(DateToString(new Date(),"yyyy-MM-dd"));
		// System.out.println(getDate("2015-05-07 00:00:00"));
		// System.out.println( DateToString(addDay(new Date(),1),"MM月dd日" ));
		// System.out.println(compareDate(new Date(),StringToDate("2016-7-19
		// 18:50:00")));
		// System.out.println(DateToString(addDay(new Date(),1),"yyyy-MM-dd
		// HH:mm:ss"));
		// System.out.println(StringToDate("2016-05-20 00:00:00"));
		// System.out.println(DateUtil.addDay(DateUtils.formatTimes2(new
		// Date()),1));
		// System.out.println(new Date().toString());
		// System.out.println(getWeek("2016/5/16 14:10:10").number);
		// System.out.println(DateUtils.formatTimes2(StringToDate("2016-05-20
		// 00:00:00")));
		// System.out.println(getWeek("Fri May 20 00:00:00 CST 2016").number);
		// Date date = StringToDate("2017-01-05 00:00:00");
		// System.out.println(getToY(date));
//		String str = "2007/5/12";
//		if (isDate(str, DateStyle.YYYY_MM_DD_HH_MM.getValue()) || isDate(str, DateStyle.YYYY_MM_DD.getValue()))
//			System.out.print("This is true");
//		else
//			System.out.println(str);

		// Date date2 = StringToDate("2017-01-06 00:00:00");
		// System.out.println(getIntervalDays(date2, date));
		//
//		 long lday = 1816976000000L;
//		 Date day = new Date(lday);
//		 System.out.println(getToY(day));
		//
//		 System.out.println(getIntervalDays(date2, date));
	}
	...
	public static String getToYYMM(Date date) {
	 ...
	 * @return
	 */
	public static String getToYYMMDD(Date date) {
	 ...
	 * @return
	 */
	public static String getToY(long date) {
		Calendar c = Calendar.getInstance();
